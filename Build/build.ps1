properties { 
  ...
  $builds = @(
    ...
    @{Name = "Newtonsoft.Json.Portable"; TestsName = "Newtonsoft.Json.Tests.Portable"; Constants="PORTABLE"; FinalDir="Portable"; NuGetDir = "portable-net45+wp80+win8+monotouch+monoandroid"; Framework="net-4.0"; Sign=$true},
