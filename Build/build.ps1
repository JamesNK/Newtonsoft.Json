properties { 
  $zipFileName = "Json50r8.zip"
  $majorVersion = "4.5"
  $majorWithReleaseVersion = "5.0.8"
  ...
  $builds = @(
    ...
    @{Name = "Newtonsoft.Json.Portable40"; TestsName = "Newtonsoft.Json.Tests.Portable40"; Constants="PORTABLE40"; FinalDir="Portable40"; NuGetDir = "portable-net40+sl4+wp7+win8+monotouch+monoandroid"; Framework="net-4.0"; Sign=$true},
