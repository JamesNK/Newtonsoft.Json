properties { 
  $zipFileName = "Json45r12.zip"
  $majorVersion = "4.5"
  $majorWithReleaseVersion = "4.5.12"
  ...
  $builds = @(
    ...
    @{Name = "Newtonsoft.Json.Portable"; TestsName = "Newtonsoft.Json.Tests.Portable"; Constants="PORTABLE"; FinalDir="Portable"; NuGetDir = "portable-net403+sl4+wp71+win8"; Framework="net-4.0"; Sign=$true},
    ...
    @{Name = "Newtonsoft.Json.WindowsPhone"; TestsName = $null; Constants="SILVERLIGHT;WINDOWS_PHONE"; FinalDir="WindowsPhone"; NuGetDir = "sl4-windowsphone71"; Framework="net-4.0"; Sign=$true},
